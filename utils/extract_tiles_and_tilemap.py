...
source_image_filename = "assets/SuperMarioKartMapMushroomCup1_clean.png"
tile_map_filename = "SD/TBL/MARIO-MAP.BIN"
tile_pixel_data_filename = "SD/TBL/MARIO-TILES.BIN"
map_width = 128
map_height = 128
...
nr_of_palette_bytes = len(palette_bytes)
